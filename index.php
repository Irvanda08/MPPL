                        ...
                        <div class="w-full h-60 rounded-xl bg-white shadow-2xl">
                            <div class=" ml-5 mt-4">
                                ...
                                <div class="block border border-black bg-gray-300  mr-4 mb-5 mt-5">
                                    <p> sodhfl sadfhla skdfl df lasjd fhlaksjdh laskdjfhaskdjfhalsk laskdjha slkdf
                                        haslkdjhf
                                        laskjdhf alskdjh alskdjfhlaskjdhfkjashdf aksdjfh askdjhf aslkdjhfalksjdh
                                        alksdfhas
                                        lkdjhaskldjhlaskjdhakj</p>
                                </div>
                            </div>
                        </div>
                    </div>
