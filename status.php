            ...
            <div class="w-screen m-2 rounded-xl bg-[#08c4fc]">
                ...
                <div class="">
                    <div class="flex justify-center mb-40">
                        <div class="flex bg-gray-200 rounded-full w-14 h-14 justify-center">01</div>
                        <div class="ml-10 mr-10 mt-3">---------------------D</div>
                        <div class="flex justify-center bg-gray-200 rounded-full w-14 h-14">02</div>
                        <div class="ml-10 mr-10 mt-3">---------------------D</div>
                        <div class="flex justify-center bg-gray-200 rounded-full w-14 h-14">03</div>
                    </div>
                        ...
                        <div class="flex items-center p-2 mx-24">
                            <div class="w-full h-60 rounded-xl bg-white shadow-2xl">
                                <div class=" ml-5 mt-4">
                                    ...
                                    <div
                                        class="block border border-black bg-gray-300  mr-4 mb-5 mt-5 rounded-xl pl-3 pr-3">
                                        <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit odit est neque explicabo id, illum vero adipisci culpa dolores doloremque aperiam molestias, ullam eum, dolore expedita voluptatum. Quis, impedit eius!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
